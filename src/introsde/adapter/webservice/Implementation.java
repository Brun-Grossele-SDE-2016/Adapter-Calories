package introsde.adapter.webservice;
...
@WebService(endpointInterface = "introsde.adapter.webservice.Interface",
serviceName="AdapterService")
public class Implementation implement Interface
{
	@Override
